...
source("https://raw.githubusercontent.com/TrevorHD/Pathfinder/master/PathfinderGridDisplay.R")

# Load pathfinder functions and sub-routines
source("https://raw.githubusercontent.com/TrevorHD/Pathfinder/master/PathfinderFunctions.R")
