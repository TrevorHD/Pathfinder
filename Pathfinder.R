...
source("D:\\Projects/Ongoing/Pathfinder/PathfinderGridDisplay.R")

# Load pathfinder functions and sub-routines
source("D:\\Projects/Ongoing/Pathfinder/PathfinderFunctions.R")
...
# Should path plotting be enabled?
# Set to FALSE if running more than 1 simulation!
plot.on <- TRUE
