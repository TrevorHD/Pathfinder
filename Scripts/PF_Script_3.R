...
source("Scripts/PF_Script_HMFix.R")

# Load pathfinder functions and sub-routines
source("Scripts/PF_Script_1.R")
...
if(replicate.on == FALSE){
  ...
  jpeg(filename = "Figures/PF_Plots_1.jpeg", width = 2000, height = 2000, units = "px")
...
if(replicate.on == TRUE){
  ...
  # Prepare graphics device
  jpeg(filename = "Figures/PF_Plots_2.jpeg", width = 2150, height = 700, units = "px")
